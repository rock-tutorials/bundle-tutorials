...
module Tutorials
  # Define a fault response table to move back to origin when the system crosses
  # a virtual fence
  class Fence < Roby::Coordination::FaultResponseTable
    ...
    # While not strictly necessary, it is a good policy to create separate
    # actions for the response steps. The fault response handlers themselves
    ...
    action_script 'move_to_origin' do
      ...
      origin.monitor('reached_center', origin.rock_child.pose_samples_port, :threshold => threshold).
        trigger_on do |pose|
          Robot.info "reached_center monitor"
